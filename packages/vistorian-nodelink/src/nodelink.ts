...
const linkWeightScale = d3.scale.linear().range([1, 1]);
...
parentSvg
    ...
    .on('wheel.zoom', () => {
        ...
        const mouse = [(d3.event).x - panOffsetGlobal[0], (d3.event).y - panOffsetGlobal[1]];
        let d: any, n: any;
...
const lineFunction: any = d3.svg.line() // only line() d3 v4
