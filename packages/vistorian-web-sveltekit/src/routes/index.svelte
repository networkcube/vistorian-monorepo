...
<main>
    ...
    <div id="main">
        ...
        <div id="intro">
            ...
            <ul id="menu">
                <li>
                    <a href="./demo?session=0&datasetName=demo_scientists" target="_blank"
                       on:click={() => trace.event('hlp_7', 'index', 'Visualizations href', 'click')}><img
                            src="./logos/eye65.png"
                            class="menuicon" target="_blank"/>Visualizations</a>
                </li>
                <li>
                    <a href="./dataview?session=0" target="_blank"
                       on:click={() => trace.event('hlp_6', 'index', 'Demo href', 'click')}><img
                            src="./logos/soccer.png"
                ...
                <li>
                    <a href="http://github.com/networkcube/networkcube/wiki/Visualization-Manual" target="_blank"
                       on:click={() => trace.event('hlp_1', 'index', 'Vis Manual', 'click')}>
                        <img src="./logos/002-share.png" class="menuicon" target="_blank"/>Visualization
                        Manual</a>
                </li>
                <li>
                ...
                <li>
                    <a href="http://github.com/networkcube/networkcube" target="_blank"
                       on:click={() => trace.event('com_1', 'index', 'github', 'click')}><img
                            src="./logos/favourite15.png"
                            class="menuicon"/>Github</a>
                </li>

                <li>
                    <a href="https://vistorian.github.io/vistorianLab.html" target="_blank" class="menuicon"
                       on:click={() => trace.event('com_2', 'index', 'vistorinaLab study', 'click')}><img
                            src="./logos/VistorianLab.png"
                            class="menuicon"/>Vistorian Lab</a>
                </li>
                <li>
                    <a href="mailto:benj.bach@gmail.com" class="menuicon"
                       on:click={() => trace.event('com_2', 'index', 'contact', 'click')}><img src="./logos/chat44.png"
            ...
            <div id="logos">
                <a href="http://www.ed.ac.uk/informatics"><img id="uoe"
                                                               src="./figures/university-of-edinburgh-logo.jpg"/></a>
                <a href="https://www.microsoft.com/en-us/research/collaboration/inria-joint-centre/"><img
                        src="./figures/msr-inria-logo.png"/></a>
                <a href="http://www.aviz.fr/"><img src="./figures/aviz.png"/></a>
                <a href="http://www.inria.fr"><img src="./figures/inria.png"/></a>
                <a href="http://research.microsoft.com/en-us/labs/redmond/"><img src="./figures/msr.png"/></a>
            </div>
        ...
        <div id="video_div">
            <video width="800" height="500" controls on:play={() =>trace.event('hlp_3', 'index', 'help video', 'play')}>
        ...
        <div id="content">
            <div id="description">
                ...
                <ul>
                    ...
                    <li>a <a href="./web/demo.html?session=0&datasetName=demo_scientists">set of online
                        visualizations</a>
            ...
            <div id="upload">
                ...
                <a id="resumeSessionLink" target="_blank"><img src="./logos/003-avatar.png" class="menuicon"
                ...
                <a href="https://github.com/networkcube/networkcube/wiki/Importing-Data"
                   on:click={() => trace.event('hlp_2', 'index', 'importing data', 'click')}>Learn more</a> about data
