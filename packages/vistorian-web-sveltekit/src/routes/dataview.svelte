		...
		<tr id="firstRow">
			...
			<td>
				<div id="visualizationListDiv">
					<ul id="visualizationList" class="nointent" />
				</div>
			</td>
		</tr>
		<tr>
			<td id="lists">
				...
				<div class="helpSidebar">
					...
					<ul style="list-style-type:disc;">
						<li>
							<a
								href="https://vistorian.github.io/gettingstarted.html"
								onclick="trace.event('hlp_8', 'dataview', 'tutorials', 'click')"
								target="_blank">How to get started?</a
							>
						</li>
						<li>
							<a
								href="https://vistorian.github.io/tutorial/bookmarks.html"
								onclick="trace.event('hlp_8', 'dataview', 'tutorials', 'click')"
								target="_blank">A Step-by-Step Guide to Create your first visualization</a
							>
						</li>
						<li>
							<a
								href="https://youtu.be/eXIDFK2vJ6Y"
								onclick="trace.event('hlp_8', 'dataview', 'tutorials', 'click')"
								target="_blank">Watch our video on how to format your data!</a
							>
						</li>
					</ul>
				</div>
