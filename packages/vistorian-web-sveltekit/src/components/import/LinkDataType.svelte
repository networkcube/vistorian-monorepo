...
<Card class="mb-3" style="width: 100%">
	...
	<CardBody>
		<h4>Link Table</h4>
		<input type="radio" bind:group={linkDataType} value={'linkTable'} on:click="{()=>{trace.event('dat_2_LT', 'data view', 'upload LK', 'Link Table');}}"/>
		...
		<h4>Node Table</h4>
		<input type="radio" bind:group={linkDataType} value={'nodeTable'} on:click="{()=>{trace.event('dat_2_NT', 'data view', 'upload NT', 'Node Table');}}"/>
