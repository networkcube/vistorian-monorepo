...
<main>
    <Modal isOpen={showConsentModal}>
        ...
        <ModalBody style="text-align: justify;font-size: 18px;">
            <p>
                <span>The Vistorian is a research prototype to build better visualizations for multivariate networks.</span>
            </p>
            <p><span>By using The Vistorian, you agree that your interactions with the tool are being anonymously logged for research purposes at the University of Edinburgh.
                    We will not log any information related to your data or browser settings.
                    No cookies or third party software will be installed.
                    For more information, please see <a
                        href="https://vistorian.github.io/studyPhase1_activityLogging.html" target="_blank">here</a>.
                </span></p>

            <p>
                <a href="/static/logging_consent/Vistorian Tracing Consent form .pdf" download>
                    <Button
                            on:click={() => trace.event('log_7', 'consent', 'downloaded', document.location.pathname)}>
                        <Icon name="download"/>
        ...
        <ModalFooter>
            ...
            <Button color="danger" style="align-items:center;width:200px;"
