...
export function updateEntryToLocationTableOSM(index: number, geoname: string, locationTable: vistorian.VTable, locationSchema: datamanager.LocationSchema) {
    if(geoname) {
        ...
        var xhr: any = $.ajax({
            ...
            headers: {  'Access-Control-Allow-Origin': 'https://www.vistorian.online/' , 'Access-Control-Allow-Methods': 'POST, GET, OPTIONS, PUT, DELETE','Access-Control-Allow-Credentials':'true','Access-Control-Allow-Headers': '*'},
