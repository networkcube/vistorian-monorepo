...
(function (networkcube) {
    ...
    */
    ...
    var NodePair = /** @class */ (function (_super) {
    ...
    var ScalarTimeSeries = /** @class */ (function () {
    ...
    * steps in the format key->value. I.e. the value for the
    * time step with ID 3 is accessed by this.3   */
    var ArrayTimeSeries = /** @class */ (function () {
     ...
     */
    var NumberQuery = /** @class */ (function (_super) {
    ...
    var StringQuery = /** @class */ (function () {
    ...
    var GraphElementQuery = /** @class */ (function (_super) {
    ...
    var LinkQuery = /** @class */ (function (_super) {
    ...
    var NodePairQuery = /** @class */ (function (_super) {
    ...
    var TimeQuery = /** @class */ (function (_super) {
    ...
    var MotifTemplate = /** @class */ (function () {
    ...
    var MotifSequence = /** @class */ (function () {
