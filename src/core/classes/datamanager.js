...
(function (networkcube) {
    ...
    var NodeSchema = /** @class */ (function (_super) {
    ...
    var LinkSchema = /** @class */ (function (_super) {
    ...
    var LocationSchema = /** @class */ (function (_super) {
        ...
        function LocationSchema(id, label, geoname, longitude, latitude, x, y, z, radius) {
            ...
            _this.geoname = -1; // actual geo name (english)
            _this.longitude = -1;
            _this.latitude = -1;
            _this.x = -1;
            _this.y = -1;
