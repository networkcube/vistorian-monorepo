// This file is from https://github.com/skokenes/d3-lasso/blob/73d602039deed1021160ba357270e0d51a778770/src/lasso.js
// It's vendored here, as the fix to make it work with d3 versions >= 6 hasn't been merged or published to npm
...
export default function lasso() {
    ...
    function lasso(_this) {
        ...
        let dragAction = drag.drag()
            .filter(ev => ev.shiftKey) // added by JSB
            .on("start",dragstart)
            .on("drag",dragmove)
            .on("end",dragend);
